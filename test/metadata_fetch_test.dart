...
void main() {
  test('JSON Serialization', () async {
    var url = Uri.https("https://flutter.dev", "");
  ...
  group('Metadata parsers', () {
    test('JSONLD', () async {
      var url = Uri.https("https://www.epicurious.com", "/");
      var response = await http.get(url);
      var document = responseToDocument(response);
    ...
    test('JSONLD II', () async {
      var url = Uri.https("https://www.epicurious.com",
          "/expert-advice/best-soy-sauce-chefs-pick-article");
    ...
    test('JSONLD III', () async {
      var url = Uri.https("https://medium.com",
          "/@quicky316/install-flutter-sdk-on-windows-without-android-studio-102fdf567ce4");
      var response = await http.get(url);
      var document = responseToDocument(response);
      // print(response.statusCode);
    ...
    test('JSONLD IV', () async {
      var url = Uri.https("https://www.distilled.net", "/");
      var response = await http.get(url);
      var document = responseToDocument(response);
      // print(response.statusCode);
    ...
    test('OpenGraph Youtube Test', () async {
      var url = Uri.https("https://www.youtube.com", "/watch?v=0jz0GAFNNIo");
      var response = await http.get(url);
      var document = responseToDocument(response);
      print(OpenGraphParser(document));
      print(OpenGraphParser(document).title);
    ...
    test('Faulty', () async {
      var url = Uri.https("https://google.ca", "/");
      var response = await http.get(url);
      var document = responseToDocument(response);
      print(response.statusCode);
